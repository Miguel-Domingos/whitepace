<template>
  <Section class="bg-[#043873] overflow-hidden">
    ...
    >
      <Heading class="text-white lg:text-center w-full lg:w-[38%]"
        >Try Whitepace today</Heading
      >

      <span class="text-xl lg:text-center text-white font-light">
